...
function About() {
  return (
    <div className="flex flex-row px-[100px] pt-[70px] gap-[70px] mt-[80px] mb-[150px]" id="about">
      ...
      <div className="flex flex-col gap-[30px] w-[60%]">
        <h2 className="text-[50px] font-[500] font-['Merriweather']">About Madhovari</h2>
        <p className="text-[#666666] text-[25px] font-[400] font-['Lato']">
