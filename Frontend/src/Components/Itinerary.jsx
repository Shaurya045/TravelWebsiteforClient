  ...
  return (
    <div className="bg-white pb-[50px] flex flex-col items-center px-[120px] mb-[50px]">
      <div className="flex flex-col mb-[120px] items-center">
        ...
        <div className="timeline relative w-full m-auto after:content-['*'] after:absolute after:w-[6px] after:h-[105%] after:bg-[#000] after:top-0 after:left-[50%] after:ml-[-3px] after:z-0 after:rounded-[10px] after:animate-[moveline_3s_linear_forwards] ">
          {itinaray.map((item, index) => {
            return (
              <div
                key={index}
                className={`${index%2 == 0 ? "left-[-250px]": "left-[62%]"} container p-[10px_50px] relative w-[50%] `}
              >
                <div className={`${index%2 == 0 ? "left-[400px]" : "left-[-97px]"}  absolute right-[-20px] top-[32px] z-10 `}>
                ...
                <div className="p-[20px_30px] relative w-[300px] rounded-[15px] bg-gray-600 text-white">
                  <h2 className="text-[20px] font-[500] mb-[10px]">{item.title}</h2>
                  <p className="text-[15px]">{item.desc}</p>
                  <span className={`${index%2 == 0 ? "border-l-[#000] border-l-[25px] right-[-25px]" : "border-r-[#000] border-r-[25px] left-[-25px]" } h-0 w-0 absolute top-[50px] z-1 border-t-transparent border-t-[25px] border-b-transparent border-b-[25px] `}></span>
                </div>
              </div>
            );
          })}
